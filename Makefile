...
SOURCES = \
	__init__.py \
	intelli_geo.py intelli_geo_dockwidget.py

PLUGINNAME = intelli_geo

PY_FILES = \
	__init__.py \
	intelli_geo.py intelli_geo_dockwidget.py

UI_FILES = intelli_geo_dockwidget_base.ui
...
ifeq ($(QGISDIR),)
    $(error QGISDIR environment variable is not set. Please set it to your QGIS installation path)
endif
